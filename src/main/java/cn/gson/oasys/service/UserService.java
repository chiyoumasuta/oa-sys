...
public interface UserService {
     ...
     * @date 2023/1/6 15:50
     */
    List<User> findUserByAreaAndRoleKey(List<String> areas, String roleKey, Integer notType);
     ...
     * @date 2023/1/6 20:01
     */
    boolean importUser(String oss);

    /**
     * 批量设置用户部门
     *
     * @param deptId  部门id
     * @param userIds 用户 多个逗号隔开
     * @return boolean
     * @author 不愿透露
     * @date 2023/2/28 16:09
     */
    boolean insertDept(Long deptId, String userIds);
     ...
     */
    List<User> findAllByDeptNotNull();


    //修改是否已读升级提示
    boolean updateReadUpgradeRecord(boolean read);
}
