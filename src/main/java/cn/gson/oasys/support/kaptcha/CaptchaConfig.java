...
public class CaptchaConfig {
    ...
    public DefaultKaptcha getKaptchaBean() {
        ...
        properties.setProperty(KAPTCHA_NOISE_COLOR, "blue");
    ...
    public DefaultKaptcha getKaptchaBeanMath() {
        ...
        // 验证码文本生成器
        properties.setProperty(KAPTCHA_TEXTPRODUCER_IMPL, "org.gcm.fiber.support.kaptcha.KaptchaTextCreator");
        // 验证码文本字符间距 默认为2
